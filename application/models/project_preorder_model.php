...
class Project_preorder_model extends CI_Model
{
	 ...
	 */
	public function get_preorders_of_user($users_id, $offset = 0, $limit = 0, $order = 'project_preorder_date', $direction = 'desc')
	{
		if ($users_id <= 0)
		{
			return -1;
		...
		$this->db->where("project_preorder.users_id", $users_id);
		if (strlen($order) > 0)
		{
