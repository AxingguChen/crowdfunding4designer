...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body id="body">
			...
			<div class="container">
				<div class="row">
					...
					<div class="sec-sub-title text-center">
						<p>We are recommened the most popular projects with different style as follow.</p>
					</div>
			...
			<div class="project-wrapper">
				...
				<figure class="mix work-item style1">
					...
					<figcaption class="overlay">
						...
						<h4>Old fashion sweater, what happened if the title is really long.</h4>
						<p>This is the old fashion sweater made of cutton, and this is the short description of this clothes. i only want to say something here to see what happened. try anything else see what is happening</p>
					</figcaption>
				</figure>
				
				<figure class="mix work-item style2">
					<img src="img/project/sweater.jpg" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item style3">
					...
					<figcaption class="overlay">
						...
						<h4>@title</h4>
						<p>@price @round @current_sale @minimum_sale @deadline</p>
					</figcaption>
				</figure>
				...
				<figure class="mix work-item style3">
					<img src="img/project/item-7.jpg" alt="">
					<figcaption class="overlay">
				...
				<figure class="mix work-item style4">
					<img src="img/project/item-8.jpg" alt="">
					<figcaption class="overlay">
				...
				<!-- repeat figure -->
				<figure class="mix work-item style1">
					<img src="img/project/overcoat.jpg" alt="">
					<figcaption class="overlay">
						<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="img/project/item-1.jpg"><i class="fa fa-eye fa-lg"></i></a>
						<h4>Old fashion sweater, what happened if the title is really long.</h4>
						<p>This is the old fashion sweater made of cutton, and this is the short description of this clothes. i only want to say something here to see what happened. try anything else see what is happening</p>
				...
				<figure class="mix work-item style2">
					<img src="img/project/overcoat.jpg" alt="">
					<figcaption class="overlay">
						<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="img/project/item-2.jpg"><i class="fa fa-eye fa-lg"></i></a>
						<h4>overcoat</h4>
						<p>Jack ma 70% $23</p>
					</figcaption>
				</figure>
		...
		<section id="woman" class="works clearfix">
			<div class="container">
				<div class="row">
		...
		<section id="man" class="works clearfix">
			<div class="container">
				<div class="row">
			...
			<div class="sec-sub-title text-center">
				<a href="javascript:;" data-filter="" class="filter">More</a><p>button (ajax) loading more</p>
			</div>
		</section>
