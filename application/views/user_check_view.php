	...
	<section id="#" class="features">
		<div class="container">
			<div class="row mb50">
				...
				<?php echo form_open("users/user_check_update/$r->users_id"); ?>
				<!-- service item -->
				<div class="col-md-4 wow fadeInLeft" data-wow-duration="500ms">
					<div class="service-item">
						...
						<div class="service-desc">
							<h3>flag_pending</h3>
								<input id="flag_pending" name = "flag_pending" type="checkbox"  <?php if ($r->flag_pending) echo "checked"; ?> />
								<label>Forbid to Apply</label>
						</div>
					</div>
				</div>
				<!-- end service item -->
				...
				<div class="col-md-4 wow fadeInUp" data-wow-duration="500ms"
					...
					<div class="service-item">
						...
						<div class="service-desc">
							<h3>flag_accepted</h3>
								<input id="flag_accepted" name = "flag_accepted" type="checkbox"  <?php if ($r->flag_accepted) echo "checked"; ?> />
								<label>Accepted as a Designer</label>
						</div>
					</div>
				</div>
				<!-- end service item -->
				...
				<div class="col-md-4 wow fadeInRight" data-wow-duration="500ms"
					...
					<div class="service-item">
						...
						<div class="service-desc">
							<h3>flag_declined</h3>
							<input id="flag_declined" name = "flag_declined" type="checkbox"  <?php if ($r->flag_declined) echo "checked"; ?> />
								<label>Declined Application</label>
						</div>
					</div>
				</div>
