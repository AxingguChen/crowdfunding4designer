			...
			<div class="row mb50">
				...
				<div class="text-center wow fadeInDown  text-center animated"
					...
					<div class="contact-form">
						...
						<div class="input-group row title-email">
							...
							<div class="input-field col-md-5">
								<input type="text" name="title" id="title"
									placeholder="give me a title" class="form-control">
							</div>
						...
						<div class="input-group row name-email">
						...
						<div class="service-desc">
							...
							<p>
								<input type="text" name="madeof" id="madeof"
									placeholder="madeof" class="form-control">
							</p>
						</div>
					</div>
				</div>
						...
						<div class="service-desc">
							...
							<p>
								<input type="text" name="howtowash" id="howtowash"
									placeholder="howtowash" class="form-control">
							</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4 wow fadeInRight" data-wow-duration="500ms"
					...
					<div class="service-item">
						...
						<div class="service-desc">
							<h3>Why Me</h3>
							<p>
								<input type="text" name="whyme" id="whyme"
									placeholder="whyme" class="form-control">
							</p>
						</div>
					</div>
				</div>
					...
					<div class="text-center wow fadeInDown  text-center animated" data-wow-duration="500ms" data-wow-delay="300ms">
						<div class="contact-form" >
							<div class="input-group">
											<input type="submit" id="form-submit" class="pull-right" value="Create project">
								</div>
								<?php echo form_close(); ?>
								<?php if(isset($rows) && $rows == 1) echo "succeed";?>
						</div>
					</div>		
				<!-- end contact form -->
		</div>
