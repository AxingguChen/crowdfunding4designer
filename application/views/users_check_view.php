	...
	<section id="works" class="works clearfix">
		...
		<div class="project_check">
			<nav>
				...
				<a href="<?php echo base_url();?>index.php/users/user_check/<?php echo $r->users_id;?>">
					<div class="row">
						<div class=" wow rubberBand animated col-md-3">
							<span class="name"><?php echo $r->lastname;?></span>
						</div>
						<div class=" wow rubberBand animated col-md-2">
							<span class="name"><?php echo $r->firstname;?></span>
						</div>
						<div class=" wow rubberBand animated col-md-2">
							<span class="name"><?php echo $r->email;?></span>
						</div>
						<div class=" wow rubberBand animated col-md-2">
							<span class="name"><?php echo $r->avatar;?></span>
						</div>
						<div class=" wow rubberBand animated col-md-3">
							<time><?php echo $r->update_date;?></time>
						</div>
					</div>
				</a>
				<!-- foreach end -->
