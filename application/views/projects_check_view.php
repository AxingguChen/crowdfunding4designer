	...
	<section id="works" class="works clearfix">
		...
		<div class="project_check">
			<nav>
				...
				<a href="<?php echo base_url();?>index.php/projects/project_check/<?php echo $r->projects_id;?>">
					<div class="row">
						...
						<div class=" wow rubberBand animated col-md-2">
							<span class="name"><?php echo $r->projects_users_id;?></span>
						</div>
						<div class=" wow rubberBand animated col-md-2">
							<span class="name">clothes_type</span>
						</div>
						<div class=" wow rubberBand animated col-md-2">
							<span class="name"><?php echo $r->cost;?></span>
						</div>
						<div class=" wow rubberBand animated col-md-3">
							<time><?php echo $r->create_date;?></time>
						</div>
					</div>
				</a>
				<!-- foreach end -->
