	...
	<section id="works" class="works clearfix">
		...
		<div class="project_check">
			<nav>
				...
				<a>
					<div class="row">
						<div class=" wow rubberBand animated col-md-3">
							<span class="name">TITLE: <b><?php echo $r->title;?></b></span>
						</div>
						<div class=" wow rubberBand animated col-md-2">
							<span class="name">PRICE: <b>$<?php echo $r->price;?></b></span>
						</div>
						<div class=" wow rubberBand animated col-md-2">

							<span class="name">NUMBER: <input type="text"
								name="project_preorder_number" id="project_preorder_number"
								value="<?php echo $r->project_preorder_number;?>"
								placeholder="project_preorder_number" class="form-control"></span>
						</div>
						<div class=" wow rubberBand animated col-md-2">
							<span class="name">SIZE: <b><?php echo $r->clothes_size_name;?></b></span>
						</div>
						<div class=" wow rubberBand animated col-md-3">
							<time>
								LAST UPDATE: <b><?php echo $r->project_preorder_date;?></b>
							</time>
						</div>
					</div>
				</a>
		...
		<div class="contact-form">
				<div class="sec-sub-title text-center input-group">
					TOTAL: <input type="text" name="total" id="total"
						value="ajax changing the price" placeholder="total" class="form-control">
				</div>
