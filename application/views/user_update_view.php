		...
		<div class="container">
			...
			<nav class="collapse navbar-collapse navbar-right" role="navigation">
				...
				<ul id="nav1" class="nav navbar-nav">
					<li class="current"><a
						href="<?php echo base_url();?>index.php/users/user_profile">profile</a></li>
					<li class="current"><a
						href="<?php echo base_url();?>index.php/verification/logout">Logout</a></li>
				</ul>
			</nav>
			<!-- /main nav -->
						...
						<div class="input-group row firstname-lastname">
							...
							<div class="input-field col-md-4">
								<input type="text" name="firstname" id="firstname"
									value="<?php echo $r->firstname;?>" placeholder="@firstname"
									class="form-control">
							</div>
							<div class="input-text-field col-md-1">Lastname:</div>
							<div class="input-field col-md-4">
								<input type="text" name="lastname" id="lastname"
									value="<?php echo $r->lastname;?>" placeholder="@lastname"
									class="form-control">
							</div>
						...
						<div class="input-group row">
							...
							<div class="col-md-10">
								<textarea name="about" id="about" placeholder="@about"
									class="form-control"><?php echo $r->about;?></textarea>
							</div>
						</div>
						...
						<div class="input-group row address-country">
							...
							<div class="input-field col-md-4">
								<input type="text" name="city" id="city"
									value="<?php echo $r->city;?>" placeholder="@city"
									class="form-control">
							</div>
							...
							<div class="input-field col-md-4">
								<input type="text" name="country" id="country"
									value="<?php echo $r->country;?>" placeholder="@country"
									class="form-control">
							</div>
						...
						<div class="input-group row firstname-lastname">
							...
							<div class="input-field col-md-4">
								<input type="text" name="zipcode" id="zipcode"
									value="<?php echo $r->zipcode;?>" placeholder="@zipcode"
									class="form-control">
							</div>
							...
							<div class="input-field col-md-4">
								<input type="text" name="address" id="address"
									value="<?php echo $r->address;?>" placeholder="@address"
									class="form-control">
							</div>
						</div>
						...
						<div class="input-group row firstname-lastname">
							...
							<div class="input-field col-md-4">
								<input type="text" name="bank_account" id="bank_account"
									...
									placeholder="@bank_account" class="form-control">
							</div>
							<div class="input-text-field col-md-1">Bank Holder:</div>
							<div class="input-field col-md-4">
								<input type="text" name="bank_holder" id="bank_holder"
									value="<?php echo $r->bank_holder;?>"
									placeholder="@bank_holder" class="form-control">
							</div>
						...
						<div class="input-group row firstname-lastname">
							...
							<div class="input-field col-md-4">
								<input type="text" name="paypal" id="paypal"
									value="<?php echo $r->paypal;?>" placeholder="@paypal"
									class="form-control">
							</div>
							<div class="input-text-field col-md-1">Cellphone:</div>
							<div class="input-field col-md-4">
								<input type="text" name="cellphone" id="cellphone"
									value="<?php echo $r->cellphone;?>" placeholder="@cellphone"
									class="form-control">
							</div>
				...
				<div class="text-center wow fadeInDown  text-center animated"
					...
					<div class="contact-form">
						...
						<div class="input-group row firstname-lastname">
							...
							<div class="input-field col-md-4">
								<input type="text" name="school" id="school"
									value="<?php echo $r->school;?>" placeholder="@school"
									class="form-control">
							</div>
							<div class="input-text-field col-md-1">Major:</div>
							<div class="input-field col-md-4">
								<input type="text" name="major" id="major"
									value="<?php echo $r->major;?>" placeholder="@major"
									class="form-control">
							</div>
						...
						<div class="input-group row">
							...
							<div class="col-md-9">upload button</div>
						</div>
