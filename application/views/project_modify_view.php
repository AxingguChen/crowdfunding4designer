					...
					<div class="input-group">
						<input type="submit" id="form-submit" class="pull-right"
							value="Update project">
								...
								<?php echo form_close(); ?>
							<?php if(isset($exc_flag) && $exc_flag == 1) echo "succeed";?>
						</div>
			</div>
			<!-- end contact form -->
		</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="sec-sub-title text-center">
					...
					<?php echo form_open_multipart('projects/upload/'.$projects_id);?>

					<input type="file" name="technical_drawing" size="20" /> <br />
					<br /> <input type="submit" value="projects/upload/'<?php echo $projects_id;?>" />
